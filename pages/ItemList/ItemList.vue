<template>
    <div class="container"> <!-- 부모 div Start -->
        <!--    carousel start-->
        <div
        ...
        <div class="container mt-4 border"> <!--    지역 카테고리 start-->
        ...
        <div class="mt-4"> <!-- 조회 | 리뷰 | 가격 Start-->
            <div class="text-end">
                <a href="#" class="link-secondary">조회순 | </a>
                <a href="#" class="link-secondary">리뷰많은순 | </a>
                <a href="#" class="link-secondary">가격낮은순</a>
            </div>
        </div> <!-- 조회 | 리뷰 | 가격 End-->

        <br />

        <div class="mb-4"> <!-- Card start#1 -->
            <div class="row">
                <div class="col"> <!-- 1번 상품 Start -->
                    <div class="card" style="width: 14rem">
                        <div class="ratio ratio-4x3"> <!-- ratio 카드 크기 고정4x3 -->
                            <img
                                src="@/assets/img/ItemListImage/ItemListImg1.jpg"
                                class="card-img-top"
                                alt="..."
                ...
                <div class="col"> <!-- 3번 상품 Start -->
                    <div class="card" style="width: 14rem">
                        <div class="ratio ratio-4x3">
                            <img
                                src="@/assets/img/ItemListImage/ItemListImg3.jpg"
                                class="card-img-top"
                                alt="..."
                            />
                        </div>
        ...
        <div class="mt-4">  <!-- Card start#2-->
            <div class="row">
                <div class="col">  <!-- 5번 상품 Start -->
                    <div class="card" style="width: 14rem">
                        <div class="ratio ratio-4x3">
                            <img
                                src="@/assets/img/ItemListImage/ItemListImg4.jpg"
        ...
        <div class="container"><!--    footer start--></div>
        <!--    footer end-->
    </div>  <!-- 부모 div End -->
</template>
