<template>
    <div id="app">
        <div class="container">
            <div class="row top">
                ...
                <div
                    ...
                    class="carousel slide carousel-fade col-md-9"
        ...
        <!-- 본문 시작 -->
        <div class="container">
            <div class="small-title">급상승 여행지</div>
            <div class="jump">
                <!-- #1 -->
                <div class="card">
                    <!-- 이미지 비율 -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="position-relative">
                            <!-- 수평 정렬 더 좋은 방법? -->
                            <!-- <span class="badge rounded-pill bg-light text-dark">서울</span>
                            <span href="#" class="badge bg-dark">Go</span> -->
